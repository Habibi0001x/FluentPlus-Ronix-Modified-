...
local Themes = {
	...
	Ronix1 = {
		Name = "Ronix1",
		Accent = Color3.fromHex("#9D6DFF"),
		AcrylicMain = Color3.fromHex("#1a1625"),
		AcrylicBorder = Color3.fromHex("#3d3547"),
		AcrylicGradient = ColorSequence.new(Color3.fromHex("#1a1625"), Color3.fromHex("#252030")),
		AcrylicNoise = 0.85,
		TitleBarLine = Color3.fromHex("#9D6DFF"),
		Tab = Color3.fromHex("#B894FF"),
		Element = Color3.fromHex("#252030"),
		ElementBorder = Color3.fromHex("#3d3547"),
		InElementBorder = Color3.fromHex("#7A4DFF"),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromHex("#4a4555"),
		ToggleToggled = Color3.fromHex("#ffffff"),
		SliderRail = Color3.fromHex("#4a4555"),
		DropdownFrame = Color3.fromHex("#B894FF"),
		DropdownHolder = Color3.fromHex("#1a1625"),
		DropdownBorder = Color3.fromHex("#3d3547"),
		DropdownOption = Color3.fromHex("#9D6DFF"),
		Keybind = Color3.fromHex("#9D6DFF"),
		Input = Color3.fromHex("#2d2838"),
		InputFocused = Color3.fromHex("#252030"),
		InputIndicator = Color3.fromHex("#b8b5c0"),
		InputIndicatorFocus = Color3.fromHex("#9D6DFF"),
		Dialog = Color3.fromHex("#252030"),
		DialogHolder = Color3.fromHex("#1a1625"),
		DialogHolderLine = Color3.fromHex("#3d3547"),
		DialogButton = Color3.fromHex("#9D6DFF"),
		DialogButtonBorder = Color3.fromHex("#7A4DFF"),
		DialogBorder = Color3.fromHex("#3d3547"),
		DialogInput = Color3.fromHex("#2d2838"),
		DialogInputLine = Color3.fromHex("#9D6DFF"),
		Text = Color3.fromHex("#ffffff"),
		SubText = Color3.fromHex("#b8b5c0"),
		Hover = Color3.fromHex("#B894FF"),
		HoverChange = 0.08,
	},
	Ronix2 = {
		Name = "Ronix2",
		Accent = Color3.fromHex("#9D6DFF"),
		AcrylicMain = Color3.fromHex("#1a1a1f"),
		AcrylicBorder = Color3.fromHex("#3d3d47"),
		AcrylicGradient = ColorSequence.new(Color3.fromHex("#1a1a1f"), Color3.fromHex("#25252d")),
		AcrylicNoise = 0.85,
		TitleBarLine = Color3.fromHex("#9D6DFF"),
		Tab = Color3.fromHex("#1a1a1f"),
		Element = Color3.fromHex("#25252d"),
		ElementBorder = Color3.fromHex("#3d3d47"),
		InElementBorder = Color3.fromHex("#7A4DFF"),
		ElementTransparency = 0.88,
		ToggleSlider = Color3.fromHex("#4a4555"),
		ToggleToggled = Color3.fromHex("#ffffff"),
		SliderRail = Color3.fromHex("#4a4555"),
		DropdownFrame = Color3.fromHex("#B894FF"),
		DropdownHolder = Color3.fromHex("#1a1a1f"),
		DropdownBorder = Color3.fromHex("#3d3d47"),
		DropdownOption = Color3.fromHex("#9D6DFF"),
		Keybind = Color3.fromHex("#9D6DFF"),
		Input = Color3.fromHex("#2d2d36"),
		InputFocused = Color3.fromHex("#25252d"),
		InputIndicator = Color3.fromHex("#b8b8c0"),
		InputIndicatorFocus = Color3.fromHex("#9D6DFF"),
		Dialog = Color3.fromHex("#25252d"),
		DialogHolder = Color3.fromHex("#1a1a1f"),
		DialogHolderLine = Color3.fromHex("#3d3d47"),
		DialogButton = Color3.fromHex("#9D6DFF"),
		DialogButtonBorder = Color3.fromHex("#7A4DFF"),
		DialogBorder = Color3.fromHex("#3d3d47"),
		DialogInput = Color3.fromHex("#2d2d36"),
		DialogInputLine = Color3.fromHex("#9D6DFF"),
		Text = Color3.fromHex("#ffffff"),
		SubText = Color3.fromHex("#b8b8c0"),
		Hover = Color3.fromHex("#B894FF"),
		HoverChange = 0.08,
	}
